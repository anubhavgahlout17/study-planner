...
# On Render (and most cloud hosts) the app directory is read-only.
# Use /tmp for writable storage, or fall back to local dev path.
...
if __name__ == "__main__":
    ...
    print(f"Study Planner running at http://127.0.0.1:{port}")
